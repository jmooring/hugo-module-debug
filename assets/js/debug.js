...
console.groupCollapsed('Language');
  console.log('Language.Direction: {{ .Site.Language.Direction }}');
  console.log('Language.IsDefault: {{ .Site.Language.IsDefault }}');
  console.log('Language.Label: {{ .Site.Language.Label }}');
  console.log('Language.Locale: {{ .Site.Language.Locale }}');
  console.log('Language.Name: {{ .Site.Language.Name }}');
console.groupEnd();
...
console.log('IsDefault: {{ .Site.IsDefault }}');
console.groupCollapsed('Language');
  console.log('Language.Direction: {{ .Site.Language.Direction }}');
  console.log('Language.IsDefault: {{ .Site.Language.IsDefault }}');
  console.log('Language.Label: {{ .Site.Language.Label }}');
...
console.groupCollapsed('MISCELLANEOUS');
  ...
  console.log('hugo.Sites: {{ hugo.Sites }}');
